 ...
 * @generated
 */
public class TestCaseMMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestCaseMMPackage.TEST_CASE_SET: {
				TestCaseSet testCaseSet = (TestCaseSet)theEObject;
				T result = caseTestCaseSet(testCaseSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestCaseMMPackage.TEST_CASE: {
				TestCase testCase = (TestCase)theEObject;
				T result = caseTestCase(testCase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestCaseMMPackage.RULE: {
				Rule rule = (Rule)theEObject;
				T result = caseRule(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestCaseMMPackage.SOURCE_MODEL: {
				SourceModel sourceModel = (SourceModel)theEObject;
				T result = caseSourceModel(sourceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestCaseMMPackage.TARGET_MODEL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test Case Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test Case Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestCaseSet(TestCaseSet object) {
		return null;
	}
