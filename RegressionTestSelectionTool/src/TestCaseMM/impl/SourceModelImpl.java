 ...
 * </p>
 * <ul>
 *   <li>{@link TestCaseMM.impl.SourceModelImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceModelImpl extends MinimalEObjectImpl.Container implements SourceModel {
	...
	protected EClass eStaticClass() {
		return TestCaseMMPackage.Literals.SOURCE_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestCaseMMPackage.SOURCE_MODEL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestCaseMMPackage.SOURCE_MODEL__NAME:
				return getName();
		}
