...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Switched Time</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getDtstart <em>Dtstart</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getDtend <em>Dtend</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getFreq <em>Freq</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getUntil <em>Until</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getCount <em>Count</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getBySecond <em>By Second</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByMinute <em>By Minute</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByHour <em>By Hour</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByDay <em>By Day</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByMonthDay <em>By Month Day</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByYearDay <em>By Year Day</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByWeekNo <em>By Week No</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getByMonth <em>By Month</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getWkst <em>Wkst</em>}</li>
 *   <li>{@link CPL2.impl.SwitchedTimeImpl#getBySetPos <em>By Set Pos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchedTimeImpl extends NodeContainerImpl implements SwitchedTime {
	/**
	...
	protected EClass eStaticClass() {
		return CPLPackage.Literals.SWITCHED_TIME;
	}
	...
	public void setDtstart(String newDtstart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__DTSTART, oldDtstart, dtstart));
	}
	...
	public void setDtend(String newDtend) {
		...
		dtend = newDtend;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__DTEND, oldDtend, dtend));
	}
	...
	public void setDuration(String newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__DURATION, oldDuration, duration));
	}
	...
	public void setFreq(String newFreq) {
		...
		freq = newFreq;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__FREQ, oldFreq, freq));
	}
	...
	public void setUntil(String newUntil) {
		...
		until = newUntil;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__UNTIL, oldUntil, until));
	}
	...
	public void setCount(String newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__COUNT, oldCount, count));
	}
	...
	public void setInterval(String newInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__INTERVAL, oldInterval, interval));
	}
	...
	public void setBySecond(String newBySecond) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_SECOND, oldBySecond, bySecond));
	}
	...
	public void setByMinute(String newByMinute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_MINUTE, oldByMinute, byMinute));
	}
	...
	public void setByHour(String newByHour) {
		...
		byHour = newByHour;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_HOUR, oldByHour, byHour));
	}
	...
	public void setByDay(String newByDay) {
		...
		byDay = newByDay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_DAY, oldByDay, byDay));
	}
	...
	public void setByMonthDay(String newByMonthDay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_MONTH_DAY, oldByMonthDay, byMonthDay));
	}
	...
	public void setByYearDay(String newByYearDay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_YEAR_DAY, oldByYearDay, byYearDay));
	}
	...
	public void setByWeekNo(String newByWeekNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_WEEK_NO, oldByWeekNo, byWeekNo));
	}
	...
	public void setByMonth(String newByMonth) {
		...
		byMonth = newByMonth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_MONTH, oldByMonth, byMonth));
	}
	...
	public void setWkst(String newWkst) {
		...
		wkst = newWkst;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__WKST, oldWkst, wkst));
	}
	...
	public void setBySetPos(String newBySetPos) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CPLPackage.SWITCHED_TIME__BY_SET_POS, oldBySetPos, bySetPos));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CPLPackage.SWITCHED_TIME__DTSTART:
				return getDtstart();
			case CPLPackage.SWITCHED_TIME__DTEND:
				return getDtend();
			case CPLPackage.SWITCHED_TIME__DURATION:
				return getDuration();
			case CPLPackage.SWITCHED_TIME__FREQ:
				return getFreq();
			case CPLPackage.SWITCHED_TIME__UNTIL:
				return getUntil();
			case CPLPackage.SWITCHED_TIME__COUNT:
				return getCount();
			case CPLPackage.SWITCHED_TIME__INTERVAL:
				return getInterval();
			case CPLPackage.SWITCHED_TIME__BY_SECOND:
				return getBySecond();
			case CPLPackage.SWITCHED_TIME__BY_MINUTE:
				return getByMinute();
			case CPLPackage.SWITCHED_TIME__BY_HOUR:
				return getByHour();
			case CPLPackage.SWITCHED_TIME__BY_DAY:
				return getByDay();
			case CPLPackage.SWITCHED_TIME__BY_MONTH_DAY:
				return getByMonthDay();
			case CPLPackage.SWITCHED_TIME__BY_YEAR_DAY:
				return getByYearDay();
			case CPLPackage.SWITCHED_TIME__BY_WEEK_NO:
				return getByWeekNo();
			case CPLPackage.SWITCHED_TIME__BY_MONTH:
				return getByMonth();
			case CPLPackage.SWITCHED_TIME__WKST:
				return getWkst();
			case CPLPackage.SWITCHED_TIME__BY_SET_POS:
				return getBySetPos();
		}
