 ...
 *   <li>{@link OO.impl.ClassImpl#getIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClassImpl extends ClassifierImpl implements OO.Class {
		...
		if (extends_ != null && extends_.eIsProxy()) {
			...
			if (extends_ != oldExtends) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OOPackage.CLASS__EXTENDS, oldExtends,
							extends_));
			}
		}
		return extends_;
	...
	public NotificationChain basicSetExtends(OO.Class newExtends, NotificationChain msgs) {
		...
		extends_ = newExtends;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OOPackage.CLASS__EXTENDS,
	...
	public void setExtends(OO.Class newExtends) {
		if (newExtends != extends_) {
			...
			if (extends_ != null)
				msgs = ((InternalEObject) extends_).eInverseRemove(this, OOPackage.CLASS__EXTENDED_BY, OO.Class.class,
						msgs);
			if (newExtends != null)
				msgs = ((InternalEObject) newExtends).eInverseAdd(this, OOPackage.CLASS__EXTENDED_BY, OO.Class.class,
						msgs);
	...
	public EList<OO.Class> getExtendedBy() {
		if (extendedBy == null) {
			extendedBy = new EObjectWithInverseResolvingEList<OO.Class>(OO.Class.class, this,
					OOPackage.CLASS__EXTENDED_BY, OOPackage.CLASS__EXTENDS);
		}
		return extendedBy;
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this, OOPackage.CLASS__FEATURES,
					OOPackage.FEATURE__OWNER);
		}
		return features;
	}
	...
	public void setIsAbstract(Boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OOPackage.CLASS__IS_ABSTRACT, oldIsAbstract,
					isAbstract));
	}
