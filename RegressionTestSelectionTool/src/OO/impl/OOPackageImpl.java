...
import OO.AnnotatedElement;
import OO.Annotation;
import OO.Attribute;
import OO.Classifier;
import OO.Datatype;
import OO.ExternalClass;
import OO.Feature;
import OO.Model;
import OO.NamedElement;
import OO.OOFactory;
import OO.OOPackage;
import OO.Operation;
import OO.PackageableElement;
import OO.Parameter;
import OO.Reference;
import OO.StructuralFeature;
import OO.VisibilityEnum;
 ...
 * @generated
 */
public class OOPackageImpl extends EPackageImpl implements OOPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see OO.OOPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OOPackageImpl() {
		super(eNS_URI, OOFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link OOPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OOPackage init() {
		if (isInited)
			return (OOPackage) EPackage.Registry.INSTANCE.getEPackage(OOPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredOOPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		OOPackageImpl theOOPackage = registeredOOPackage instanceof OOPackageImpl ? (OOPackageImpl) registeredOOPackage
				: new OOPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theOOPackage.createPackageContents();

		// Initialize created meta-data
		theOOPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOOPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OOPackage.eNS_URI, theOOPackage);
		return theOOPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getStructuralFeature_IsMany() {
	 ...
	 * @generated
	 */
	public OOFactory getOOFactory() {
		return (OOFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(structuralFeatureEClass, STRUCTURAL_FEATURE__IS_MANY);
	...
	public void initializePackageContents() {
		...
		externalClassEClass.getESuperTypes().add(this.getClass_());
		...
		initEClass(packageableElementEClass, PackageableElement.class, "PackageableElement", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackageableElement_Package(), this.getPackage(), this.getPackage_Contents(), "package", null,
				0, 1, PackageableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(annotatedElementEClass, AnnotatedElement.class, "AnnotatedElement", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAnnotatedElement_Annotations(), this.getAnnotation(), null, "annotations", null, 0, -1,
		...
		initEClass(annotationEClass, Annotation.class, "Annotation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAnnotation_Key(), ecorePackage.getEString(), "key", null, 0, 1, Annotation.class,
		...
		initEClass(packageEClass, OO.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Contents(), this.getPackageableElement(), this.getPackageableElement_Package(),
				"contents", null, 0, -1, OO.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classifierEClass, Classifier.class, "Classifier", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(externalClassEClass, ExternalClass.class, "ExternalClass", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(classEClass, OO.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_Extends(), this.getClass_(), this.getClass_ExtendedBy(), "extends", null, 0, 1,
				OO.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_ExtendedBy(), this.getClass_(), this.getClass_Extends(), "extendedBy", null, 0, -1,
				OO.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Features(), this.getFeature(), this.getFeature_Owner(), "features", null, 0, -1,
				OO.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClass_IsAbstract(), ecorePackage.getEBooleanObject(), "isAbstract", null, 0, 1,
				OO.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
		...
		initEReference(getFeature_Owner(), this.getClass_(), this.getClass_Features(), "owner", null, 0, 1,
				Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_Type(), this.getClassifier(), null, "type", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getFeature_Visibility(), this.getVisibilityEnum(), "visibility", null, 0, 1, Feature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(structuralFeatureEClass, StructuralFeature.class, "StructuralFeature", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStructuralFeature_IsMany(), ecorePackage.getEBooleanObject(), "isMany", null, 0, 1,
				StructuralFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(operationEClass, Operation.class, "Operation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOperation_Parameters(), this.getParameter(), this.getParameter_Owner(), "parameters", null, 0,
				-1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(parameterEClass, Parameter.class, "Parameter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParameter_Type(), this.getClassifier(), null, "type", null, 0, 1, Parameter.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getParameter_Owner(), this.getOperation(), this.getOperation_Parameters(), "owner", null, 0, 1,
