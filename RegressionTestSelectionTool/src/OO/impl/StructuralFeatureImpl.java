 ...
 * </p>
 * <ul>
 *   <li>{@link OO.impl.StructuralFeatureImpl#getIsMany <em>Is Many</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StructuralFeatureImpl extends FeatureImpl implements StructuralFeature {
	...
	public void setIsMany(Boolean newIsMany) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OOPackage.STRUCTURAL_FEATURE__IS_MANY, oldIsMany,
					isMany));
	}
