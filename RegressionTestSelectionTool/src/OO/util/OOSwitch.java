...
public class OOSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case OOPackage.MODEL: {
			...
			if (result == null)
				result = caseAnnotatedElement(model);
			if (result == null)
		...
		case OOPackage.PACKAGEABLE_ELEMENT: {
			...
			if (result == null)
				result = caseAnnotatedElement(packageableElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OOPackage.NAMED_ELEMENT: {
			...
			if (result == null)
				result = caseAnnotatedElement(namedElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.PACKAGE: {
			OO.Package package_ = (OO.Package) theEObject;
			...
			if (result == null)
				result = caseAnnotatedElement(package_);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.CLASSIFIER: {
			...
			if (result == null)
				result = caseAnnotatedElement(classifier);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.EXTERNAL_CLASS: {
			...
			if (result == null)
				result = caseClass(externalClass);
			if (result == null)
				result = caseClassifier(externalClass);
			if (result == null)
				result = casePackageableElement(externalClass);
			if (result == null)
				result = caseNamedElement(externalClass);
			if (result == null)
				result = caseAnnotatedElement(externalClass);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.CLASS: {
			OO.Class class_ = (OO.Class) theEObject;
			...
			if (result == null)
				result = caseAnnotatedElement(class_);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OOPackage.FEATURE: {
			...
			if (result == null)
				result = caseAnnotatedElement(feature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.STRUCTURAL_FEATURE: {
			...
			if (result == null)
				result = caseAnnotatedElement(structuralFeature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.OPERATION: {
			...
			if (result == null)
				result = caseAnnotatedElement(operation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.PARAMETER: {
			...
			if (result == null)
				result = caseAnnotatedElement(parameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.REFERENCE: {
			...
			if (result == null)
				result = caseFeature(reference);
			if (result == null)
				result = caseNamedElement(reference);
			if (result == null)
				result = caseAnnotatedElement(reference);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OOPackage.ATTRIBUTE: {
			...
			if (result == null)
				result = caseAnnotatedElement(attribute);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T casePackage(OO.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(OO.Class object) {
		return null;
	}
